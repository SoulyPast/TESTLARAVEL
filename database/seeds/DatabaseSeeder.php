...
class DatabaseSeeder extends Seeder
{
    private $arrayPeliculas = array(
		...
		array(
			...
			'poster' => 'https://pbs.twimg.com/media/DlyIVIEU0AEh0fh?format=jpg&name=large', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://images-na.ssl-images-amazon.com/images/I/71KKnwXlYhL._SL1231_.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'http://e00-marca.uecdn.es/assets/multimedia/imagenes/2017/06/09/14970057364455.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://images.justwatch.com/poster/147106295/s592', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://images-na.ssl-images-amazon.com/images/I/51vLLaqn8dL.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'http://es.web.img2.acsta.net/pictures/15/10/23/15/45/106018.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://http2.mlstatic.com/seven-brad-pitt-pelicula-dvd-D_NQ_NP_895011-MLM31220142317_062019-F.jpg', 
			'rented' => true, 
		...
		array(
			...
			'year' => '1987', 
			'director' => 'Stanley Kubrick', 
			'poster' => 'https://elfinalde.com/wp-content/uploads/2016/03/AfJE8hQew1FD2zHRgDy2yY3ZHpS-804x1024.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'http://barkerhost.com/wp-content/uploads/sites/4/2017/12/xjOUbhs1B80vV9lD2W9g7cNlUJY-7.jpg', 
			'rented' => true, 
	...
	private $arrayUsers= array(
		...
		private function seedUsers(){
			...
			private $arrayCategory= array(
				array(
					'title' => 'Terror',
					'description' => 'terror terror xd', 
					'adult' => true,
				),array(
					'title' => 'Action',
					'description' => 'action action xd', 
					'adult' => true,
				),array(
					'title' => 'Comedia',
					'description' => 'comedia comedia xd', 
					'adult' => false,
				));
				...
				private function seedCategory(){
					...
					foreach($this->arrayCategory as $categorie ) {
						$p = new Categorie;
						$p->title = $categorie['title'];
						$p->description = $categorie['description'];
						$p->adult = $categorie['adult'];
						$p->save();
					}}
